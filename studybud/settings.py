...
SECRET_KEY = 'django-insecure-ek(6dr*z-a59d+orlg)k3zq^trv6l9px_l&#k)=z$j5wkj*f*0'
...
TEMPLATES = [
    {
        ...
        # to make it understand that all the templates are in the template file of the base directory
